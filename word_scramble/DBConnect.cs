    ...
    class DBConnect
    {
        ...
        public List<string>[] Select()
        {
            ...
            if (OpenConnection() == true)
            {
                ...
                while (dataReader.Read())
                {
                    ...
                    list[1].Add(dataReader["word"] + "");
                    list[2].Add(dataReader["meaning"] + "");
                    list[3].Add(dataReader["usage"] + "");
                }
        ...
        public void Backup()
        {
            try
            {
                ...
                string path;
                path = "E:\\sudarsan\\Backup_database\\MySqlBackup" + year + "-" + month + "-" + day +
        ...
        public void Restore()
        {
            try
            {
                //Read file from C:\
                string path;
                path = "E:\\sudarsan\\Backup_database\\MySqlBackup.sql";
